  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse at 30% 50%, hsl(252 85% 60% / 0.15) 0%, transparent 60%)" }} />
        <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse at 70% 30%, hsl(200 100% 50% / 0.1) 0%, transparent 60%)" }} />
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
        ...
        >
          Crafting stunning UI/UX, powerful web & app solutions, SEO strategies, and digital marketing campaigns that transform your business.
        </motion.p>
        ...
        >
          <a href="#contact" className="gradient-button px-8 py-3.5 text-base">
            Get Started
          </a>
          <a href="#portfolio" className="px-8 py-3.5 text-base font-semibold rounded-2xl border border-border bg-secondary/50 backdrop-blur-sm hover:bg-secondary transition-all">
            View Portfolio
          </a>
        </motion.div>
      </div>
