      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
            ...
            <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold mt-3 mb-4">Our <span className="gradient-text">Services</span></h2>
            <p className="text-muted-foreground leading-relaxed max-w-lg">
              From design to deployment, we offer end-to-end digital solutions that help your business thrive in the modern landscape.
            </p>
          </motion.div>
